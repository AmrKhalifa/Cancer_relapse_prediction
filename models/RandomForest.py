...
rf_random = RandomizedSearchCV(estimator = RandomForestClassifier(), param_distributions = random_grid, n_iter = 100, cv = 5, verbose=2, random_state=30, n_jobs = -1)
...
train_error = (ypredict != ytrain).mean()
score = cvs(rf_best, xtrain, ytrain, cv=5, scoring='accuracy',verbose=2)
print ('score = {0}'.format(score.mean()))
#6521416153