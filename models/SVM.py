...
xtrain, ytrain, xtest = data_reader.read_data()
xtrain = xtrain.T
...
score = cvs(classifier, xtrain, ytrain, cv=5, scoring='accuracy')
roc_auc_score = cvs(classifier, xtrain, ytrain, cv=5, scoring='roc_auc')
print('accuracy with best C is {0}'.format(score.mean()))
print('roc_auc_score with best C is {0}'.format(roc_auc_score.mean()))
